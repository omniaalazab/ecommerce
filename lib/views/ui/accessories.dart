...
class _AccessoriesState extends State<Accessories> {
  late Query accessoriesQuery;
  @override
  void initState() {
    context
        .read<GetSpecificProductCubit>()
        .getTypeProduct(typeProduct: "accessories");
    // accessoriesQuery =
    //     GetSpecificProduct.getProduct(typeProduct: 'accessories');
    super.initState();
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: BlocBuilder<GetSpecificProductCubit,
